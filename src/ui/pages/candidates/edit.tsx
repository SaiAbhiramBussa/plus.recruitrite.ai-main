...
import EditProfileSection from "@/src/component/candidates/EditProfileSection";
  ...
  return (
    <div className="min-h-screen">
      ...
      <div
        ...
        className="flex flex-col gap-4 w-full px-6 grow min-h-screen"
      >
        <div className="flex flex-col w-full divide-y">
          <div style={{ backgroundColor: color?.innerBg }}></div>
          <br />
          {loading && (
            <div className="text-center items-center justify-center flex py-5">
              <div aria-label="Loading..." role="status">
                <svg className="h-6 w-6 animate-spin" viewBox="3 3 18 18">
                  <path
                    style={{
                      fill: colorToRGBA(color?.secondaryAccent, color?.opacity),
                    }}
                  ...
                  <path
                    style={{ fill: color?.secondaryAccent }}
